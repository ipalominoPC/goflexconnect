        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Create a new floor or level for this project</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-goflex-blue focus:ring-2 focus:ring-goflex-blue/20 transition-all"
                required
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Level/Floor Number <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                value={level}
            ...
            <div>
              ...
              {floorPlanImage ? (
                ...
                <button
                  type="button"
                  onClick={() => fileInputRef.current?.click()}
                  className="w-full border-2 border-dashed border-gray-300 rounded-xl p-8 hover:border-goflex-blue hover:bg-blue-50/50 transition-all"
                >
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-goflex-blue focus:ring-2 focus:ring-goflex-blue/20 transition-all resize-none"
              />
            </div>
