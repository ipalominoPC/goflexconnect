      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 mb-6">
          ...
          <div className="space-y-2">
            {project.location && (
              <p className="text-gray-600 text-lg"><span className="font-semibold">Location:</span> {project.location}</p>
            )}
            {project.buildingLevel && (
              <p className="text-gray-600 text-lg"><span className="font-semibold">Level:</span> {project.buildingLevel}</p>
            )}
          </div>
          {project.notes && (
            <p className="text-gray-600 text-base mt-5 p-4 bg-gray-50 rounded-xl border border-gray-100">{project.notes}</p>
          )}
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 mb-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Manage multiple floors for this building</p>
            </div>
            <button
          ...
          {floors.length > 0 ? (
            ...
            <p className="text-sm text-gray-500">No floors added yet. Add floors to organize measurements by level.</p>
          )}
        </div>

        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 mb-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900">Floor Plan (Legacy)</h2>
            <button
