/*
  # Fix admin analytics function session event types
  
  1. Changes
    - Update admin_get_analytics() to use correct event types
    - Change from 'session_started' to 'sign_in' 
    - This matches the actual session_events table constraint
    
  2. Reason
    - The function was querying for 'session_started' which doesn't exist
    - Valid types are: 'sign_in', 'sign_out', 'project_open'
    - This was causing "relation does not exist" errors
*/
